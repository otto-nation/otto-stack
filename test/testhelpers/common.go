...
func AssertErrorPattern(t *testing.T, result interface{}, err error, expectError bool, operation string) {
	t.Helper()
	if expectError {
...
func AssertHandlerInterface(t *testing.T, handler interface{}) {
	t.Helper()
