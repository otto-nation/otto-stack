...
func TestDetector_DetectContext(t *testing.T) {
	...
	t.Run("detects shared mode when no project", func(t *testing.T) {
...
func TestDetector_Detect(t *testing.T) {
	...
	t.Run("detects execution context", func(t *testing.T) {
...
func TestExecutionMode_Interface(t *testing.T) {
	t.Run("SharedMode implements ExecutionMode", func(t *testing.T) {
		mode := &SharedMode{Shared: &SharedInfo{Root: "/test"}}
		assert.Equal(t, "/test", mode.SharedRoot())
	})

	t.Run("ProjectMode implements ExecutionMode", func(t *testing.T) {
		mode := &ProjectMode{
