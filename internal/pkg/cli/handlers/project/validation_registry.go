...
type ValidationFunc func(*InitHandler, []services.ServiceConfig, *base.BaseCommand) error
...
func validateDocker(h *InitHandler, serviceConfigs []services.ServiceConfig, base *base.BaseCommand) error {
...
func validateConfigSyntax(h *InitHandler, serviceConfigs []services.ServiceConfig, base *base.BaseCommand) error {
...
func validateServiceDefinitions(h *InitHandler, serviceConfigs []services.ServiceConfig, base *base.BaseCommand) error {
...
func validateFilePermissions(h *InitHandler, serviceConfigs []services.ServiceConfig, base *base.BaseCommand) error {
